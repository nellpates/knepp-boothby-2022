...
k.rich <- as.data.frame(readRDS("clean-data/nulls/k.rich.vars2022.RDS"))
k.pd <- as.data.frame(readRDS("clean-data/nulls/k.pd.vars2022.RDS"))
k.ses.mpd <- as.data.frame(readRDS("clean-data/nulls/k.ses.mpd.vars2022.RDS"))
k.ses.mntd <- as.data.frame(readRDS("clean-data/nulls/k.ses.mntd.vars2022.RDS"))

b.rich <- as.data.frame(readRDS("clean-data/nulls/b.rich.vars2022.RDS"))
b.pd <- as.data.frame(readRDS("clean-data/nulls/b.pd.vars2022.RDS"))
b.ses.mpd <- as.data.frame(readRDS("clean-data/nulls/b.ses.mpd.vars2022.RDS"))
b.ses.mntd <- as.data.frame(readRDS("clean-data/nulls/b.ses.mntd.vars2022.RDS"))
...
SR_knepp_2022 <- ggplot(k.rich, aes(x = name, y = value, fill = name))+
...
SR_boothby_2022 <- ggplot(b.rich, aes(x = name, y = value, fill = name))+
  xlab("")+
  ylab("")+
...
PD_knepp_2022 <- ggplot(k.pd, aes(x = name, y = value, fill = name))+
  xlab("")+
  ylab("Proportion of variance")+
...
PD_boothby_2022 <- ggplot(b.pd, aes(x = name, y = value, fill = name))+
  xlab("")+
  ylab("")+
  scale_y_continuous(breaks = seq(0, 1, by = .2))+
  geom_violin(
...
MPD_knepp_2022 <- ggplot(k.ses.mpd, aes(x = name, y = value, fill = name))+
  xlab("")+
  ylab("Proportion of variance")+
  scale_y_continuous(breaks = seq(0, 1, by = .2))+
  geom_violin(
...
MPD_boothby_2022 <- ggplot(b.ses.mpd, aes(x = name, y = value, fill = name))+
  xlab("")+
  ylab("")+
  scale_y_continuous(breaks = seq(0, 1, by = .2))+
  geom_violin(
...
MNTD_knepp_2022 <- ggplot(k.ses.mntd, aes(x = name, y = value, fill = name))+
  xlab("")+
  ylab("Proportion of variance")+
  scale_y_continuous(breaks = seq(0, 1, by = .2))+
  geom_violin(
...
MNTD_boothby_2022 <- ggplot(b.ses.mntd, aes(x = name, y = value, fill = name))+
  xlab("")+
  ylab("")+
  scale_y_continuous(breaks = seq(0, 1, by = .2))+
  geom_violin(
...
grid.arrange(SR_knepp_2022, SR_boothby_2022,
             PD_knepp_2022, PD_boothby_2022,
             MPD_knepp_2022, MPD_boothby_2022,
             MNTD_knepp_2022, MNTD_boothby_2022, ncol=2)
...
grid.arrange(SR_knepp_2022, SR_boothby_2022, ncol=2)
...
grid.arrange(PD_knepp_2022, PD_boothby_2022, ncol=2)
# ----------------------------------------------------------------------------#
#### SES MPD - KNEPP ####
# ----------------------------------------------------------------------------#
...
grid.arrange(MPD_knepp_2022, MPD_boothby_2022, ncol=2)
...
grid.arrange(MNTD_knepp_2022, MNTD_boothby_2022, ncol=2)
