...
# Nell Pates
# SUPPLEMENTARY INFORMATION - Boothby pseudoreplicates 2022
# 2 September 2024 - FINAL

# The raw data for Boothby (boothby2022.csv) has a column 'survey' with three categories: A, B, or C.
...
# Load data
boothby <- read.csv("raw-data/boothby2022.csv")
...
write.csv(boothby, file = "clean-data/boothby_clean_w_assumptions2022.csv")
boothby <- read.csv("clean-data/boothby_clean_w_assumptions2022.csv")
...
write.csv(boothby.full, file = "clean-data/boothby_clean_full2022.csv")
boothby.full <- read.csv("clean-data/boothby_clean_full2022.csv")
...
write.csv(boothby.photos, file = "clean-data/boothby_clean_photos2022.csv")
boothby.photos <- read.csv("clean-data/boothby_clean_photos2022.csv")
