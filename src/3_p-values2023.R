...
k.rich.nulls <- as.data.frame(readRDS("clean-data/nulls/k.rich.vars2023.RDS"))
k.pd.nulls <- as.data.frame(readRDS("clean-data/nulls/k.pd.vars2023.RDS"))
k.ses.mpd.nulls <- as.data.frame(readRDS("clean-data/nulls/k.ses.mpd.vars2023.RDS"))
k.ses.mntd.nulls <- as.data.frame(readRDS("clean-data/nulls/k.ses.mntd.vars2023.RDS"))

b.rich.nulls <- as.data.frame(readRDS("clean-data/nulls/b.rich.vars2023.RDS"))
b.pd.nulls <- as.data.frame(readRDS("clean-data/nulls/b.pd.vars2023.RDS"))
b.ses.mpd.nulls <- as.data.frame(readRDS("clean-data/nulls/b.ses.mpd.vars2023.RDS"))
b.ses.mntd.nulls <- as.data.frame(readRDS("clean-data/nulls/b.ses.mntd.vars2023.RDS"))
