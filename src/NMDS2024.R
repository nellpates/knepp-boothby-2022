...
# Load data
plants <- read.csv("raw-data/all-plants2024.csv") # all data from Knepp and Boothby surveys
...
saveRDS(betaplants, "clean-data/betaplants2024.RDS")

betaplants <- readRDS("clean-data/betaplants2024.RDS")
