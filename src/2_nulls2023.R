...
saveRDS(k.rich.vars, "k.rich.vars2023.RDS") # save each output
...
saveRDS(b.rich.vars, "b.rich.vars2023.RDS")
...
saveRDS(k.pd.vars, "k.pd.vars2023.RDS")
...
saveRDS(b.pd.vars, "b.pd.vars2023.RDS")
...
saveRDS(k.ses.mpd.vars, "k.ses.mpd.vars2023.RDS")
...
saveRDS(b.ses.mpd.vars, "b.ses.mpd.vars2023.RDS")
...
saveRDS(k.ses.mntd.vars, "k.ses.mntd.vars2023.RDS")
...
saveRDS(b.ses.mntd.vars, "b.ses.mntd.vars2023.RDS")

# uncomment to save whole workspace
save.image("null_permutations2023.RData")